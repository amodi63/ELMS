{{-- <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="0"
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('employees.index') }}" class="menu-link menu-toggle">
                                    ...
                                    <span class="menu-text">List - Employees</span>
                                    @if(\App\Models\User::employees()->count())
                                    <span class="menu-label">
                                        
                                        <span class="label label-rounded label-primary">{{\App\Models\User::employees()->count() }}</span>
                                    </span>
                                    @endif
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ Auth::user()->isAdmin() ? route('employee.leaveRequests.show') : route('employee.leaveRequests.show', Auth::user()->id) }}" class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">List - Leave Requests</span>
                                    @php
                                    $leaveRequestCount = Auth::user()->isAdmin() ? \App\Models\LeaveRequest::count() : Auth::user()->leaveRequests()->count();
                                    @endphp
                                    @if($leaveRequestCount)
                                    <span class="menu-label">
                                        <span class="label label-rounded label-primary">{{ $leaveRequestCount }}</span>
                                    </span>
                                    @endif
                                </a>
                            </li>
