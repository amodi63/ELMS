...
class LeaveRequestController extends Controller
{
    ...
    public function store(LeaveRequestRequest $request) {
        if(LeaveRequest::where('user_id', $request->user_id)->where('status', '=', 'Pending')->first() ) return response()->json(['message'=> 'You have requests under review!', 'status'=>false]);
         $leave_request = LeaveRequest::create($request->all());
        return response()->json(['data'=> $leave_request, 'message'=> 'Your Request Send Successfully!', 'status'=>true]);
